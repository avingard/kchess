...
@kotlin.jvm.JvmName("-initializefields")
public inline fun fields(block: FieldsKt.Dsl.() -> kotlin.Unit): Fields =
  FieldsKt.Dsl._create(Fields.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `Fields`
 */
public object FieldsKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: Fields.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: Fields.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): Fields = _builder.build()
...
public inline fun Fields.copy(block: FieldsKt.Dsl.() -> kotlin.Unit): Fields =
  FieldsKt.Dsl._create(this.toBuilder()).apply { block() }._build()
